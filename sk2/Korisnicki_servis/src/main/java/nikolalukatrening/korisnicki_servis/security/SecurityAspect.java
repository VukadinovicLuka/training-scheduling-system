package nikolalukatrening.korisnicki_servis.security;

import nikolalukatrening.korisnicki_servis.security.CheckSecurity;
...
public class SecurityAspect {
    ...
    @Around("@annotation(nikolalukatrening.korisnicki_servis.security.CheckSecurity)")
